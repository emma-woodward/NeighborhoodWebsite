...
function PublicDocuments() {
  ...
  return (
    <div>
        ...
        <Document DocumentTitle="Example Doc" DocumentLink="https://www.dropbox.com/s/5q6wz81y83jofj7/document.pdf?dl=0" DocumentDesc="This is an example description of a potential document"/>
    </div>
  );
}
